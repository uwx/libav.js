...
define([[[buildrule]]], [[[
build/SVT-AV1-v$(SVT_AV1_VERSION)/build-$1/Makefile: build/SVT-AV1-v$(SVT_AV1_VERSION)/PATCHED | build/inst/$1/cflags.txt
	mkdir -p build/SVT-AV1-v$(SVT_AV1_VERSION)/build-$1
